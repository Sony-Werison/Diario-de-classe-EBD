            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="w-auto sm:min-w-48 justify-between bg-card border-border hover:bg-card">
                ...
                {currentClass && <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="w-auto sm:min-w-48 justify-between bg-card border-border hover:bg-card" disabled={currentClass.students.length === 0}>
