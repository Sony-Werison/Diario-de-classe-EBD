            ...
            <div className="flex flex-col sm:flex-row items-center gap-2">
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="sm:w-48 justify-between bg-card border-border hover:bg-card">
                ...
                {currentClass && <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="sm:w-48 justify-between bg-card border-border hover:bg-card" disabled={currentClass.students.length === 0}>
